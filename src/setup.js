...
<body>
  <div class="card">
    ...
    <div class="ru-banner">
      📍 <b>Если ты из России или Беларуси без VPN</b> — единственный надёжный вариант <b>🇷🇺 Polza.ai</b> (платный, рубли через карту, ~100₽ на сотни запросов). Остальные провайдеры заблокированы по IP и вернут «ключ не принят», даже если ключ правильный. С VPN — работают все.
    </div>
