...
| **OpenRouter** | Kimi K2.5 / DeepSeek V4 | 50 запросов/день (на 28 free-моделей) |
| **Google Gemini** | Gemini 2.5 Flash | 250–1500 запросов/день (Google рандомизирует) |

Подключение всех четырёх = **15 000+ запросов в день** суммарно, плюс автоматический фолбэк когда один упрётся.
