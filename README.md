...
### Простой способ — одна команда в Терминале (рекомендуем, без блокировок)

**Шаг 1.** Открой Терминал: нажми ⌘+Пробел, набери «Терминал», Enter.

**Шаг 2.** Скопируй и вставь эту строку, нажми Enter:

```bash
curl -fsSL https://github.com/alexrexby/krasavacode/releases/latest/download/install-mac.command | bash
```
